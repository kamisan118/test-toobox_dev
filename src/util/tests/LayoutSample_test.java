...
public class LayoutSample_test extends Application {
    ...
    public static void main(String[] args) {
        ...
        launch(LayoutSample_test.class, args);
    }
...
// Use a border pane as the root for scene
      ...
      /*  border.addEventHandler(KeyEvent.KEY_PRESSED, new EventHandler<KeyEvent>() {
                                             public void handle(
        ...
        /*final EventHandler<KeyEvent> keyEventHandler =
            ...
            hbox.setOnKeyPressed(keyEventHandler);*/
...
// call replaces the grid from the first call        
        ...
        stage.setTitle("vocabulary_G GUIver");
        stage.show();
    }
 ...
 */
    ...
    private HBox addHBox() {
        ...
        hbox.setStyle("-fx-background-color: #faebd7;");
 ...
 */
    private GridPane addGridPane() {
        ...
        ImageView imageHouse = new ImageView(
                    new Image(LayoutSample_test.class.getResourceAsStream("graphics/house.png")));
        ...
        ImageView imageChart = new ImageView(
                    new Image(LayoutSample_test.class.getResourceAsStream("graphics/piechart.png")));
 ...
 */
    private FlowPane addFlowPane() {
        ...
        for (int i=0; i<8; i++) {
        	imgs[i] = new Image(".\\pic\\ho.gif");
            pages[i] = new ImageView(imgs[i]);
            flow.getChildren().add(pages[i]);                        
        }
        
        //imgs[1] = new Image(".\\pic\\msn.jpg");
        //pages[1].setImage(new Image(".\\pic\\msn.jpg"));
      //new Image(LayoutSample.class.getResourceAsStream("pic/msn.png")));
