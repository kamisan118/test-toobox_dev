...
public class preproc_manager_100B_CFM_EXPR2_before2013 {
	...
	public static void pic_results_gen(){
		...
		final String inputDir = "C:/DBoxs/prim/Dropbox/特設-校務大小事/VBM Lab/1_投稿工作站/MScript_J09 (AC-KM@CFM_EXPR2)/_data processing/1_mixed CFM+SD _ only male (30)";
		...
		try {
			...
			while( e.hasMoreElements() )
			{
				...
				if(dir_name.matches("[0-9]{3,}")){
		    		...
		    		al_in = fileRead.get2D_arraylist_string_from_file(file_path, "\t");		
